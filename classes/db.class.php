	...
	*/
	public static function get()
	{
		if(is_null(static::$instance))
			static::$instance = new PDO(config::get('db_type').':dbname='.config::get('db_name').';port='.config::get('db_port').';host='.config::get('db_host'),config::get('db_user'),config::get('db_password'));
