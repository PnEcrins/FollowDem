<?php /* Smarty version Smarty-3.1.14, created on 2018-10-28 22:40:35
         compiled from "./templates/index.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:1259802915bd6334ec445b8-42461586%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1259802915bd6334ec445b8-42461586',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5bd6334eda96f7_39724733',
  'variables' => 
  array (
    'periode_valeurs' => 0,
    'periodes' => 0,
...
<?php if ($_valid && !is_callable('content_5bd6334eda96f7_39724733')) {function content_5bd6334eda96f7_39724733($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/MAMP/htdocs/FollowDem/classes/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="fr">
  <?php echo $_smarty_tpl->getSubTemplate ("head.inc.tpl.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>


  <body>

    <?php echo $_smarty_tpl->getSubTemplate ("nav.inc.tpl.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['periodes']->value==$_smarty_tpl->tpl_vars['periode_min']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['periodes']->value;?>
 ...
 $_from = $_smarty_tpl->tpl_vars['animals']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
					<div id="<?php echo $_smarty_tpl->tpl_vars['tracked_objects']->value->getId();?>
...
;padding:6px;"></div>
					...
					<?php }?>
						<h3><?php if ($_smarty_tpl->tpl_vars['tracked_objects']->value->get_object_feature('sexe')){?><img src="images/<?php if ($_smarty_tpl->tpl_vars['tracked_objects']->value->get_object_feature('sexe')=='M'){?>male<?php }else{ ?>women<?php }?>.png" width="18" height="18" />&nbsp;&nbsp;<?php }?><?php echo $_smarty_tpl->tpl_vars['tracked_objects']->value->getName();?>
</h3>
...
<?php echo $_smarty_tpl->getSubTemplate ("bottom.inc.tpl.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
